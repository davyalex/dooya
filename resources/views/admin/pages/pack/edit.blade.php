...
<div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="pt-1 pb-5 justify-content-around">
        ...
        <h5 class="card-title text-center pb-0 fs-4">Modifier un pack</h5>
      </div>

      <form action="{{ route('pack.update',$pack['id']) }}" method="POST" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
     ...
     <div class="card-body">
         ...
         <p class="card-text">
           ...
           <div class="col-12 mb-3">
             <label class="form-label">Type du pack</label>
               <select name="category"  class="form-select @error('category') is-invalid @enderror" aria-label="Default select example" required>
                 ...
                 <option  class="text-uppercase" style="font-weight:bold; margin-bottom:10px; color:rgb(53, 53, 235)"  value="{{ $item['id'] }}" {{ $item['id'] == $pack['category_pack_id'] ? 'selected' : ''  }}>{{ $item['title'] }}</option>
                 @endforeach
           ...
           @enderror
             ...
             <div class="col-12 mb-3">
                 <label for="yourName" class="form-label">Titre du pack</label>
                 <input type="text" value="{{ $pack['title'] }}" name="title" class="form-control" id="yourName" >
                 {{-- <div class="invalid-feedback">Champs obligatoire</div> --}}
               </div>
       
               <div class="col-12 mb-3">
                 <label for="yourEmail" class="form-label">Prix du pack</label>
                 <input type="number" value="{{ $pack['prix'] }}" name="prix" class="form-control" id="yourEmail" required>
                 <div class="invalid-feedback">Champs obligatoire</div>
               </div>
     ...
     <div class="card-body">
         ...
         <p class="card-text">
             <div class="col-12 mb-3">
                 ...
                 <input type="number" value="{{ $pack['prix_promo'] }}" name="prix_promo" class="form-control" id="yourName">
                 {{-- <div class="invalid-feedback">Please, enter your name!</div> --}}
             </div>
     
             <div class="col-12 mb-3">
                 <label for="yourEmail" class="form-label">Date debut promo</label>
                 <input type="date" value="{{ $pack['date_debut_promo'] }}" name="date_debut_promo" class="form-control" id="yourEmail">
             </div>

             <div class="col-12 mb-3">
                 <label for="yourEmail" class="form-label">Date fin promo</label>
                 <input type="date" value="{{ $pack['date_debut_promo']  }}" name="date_fin_promo" class="form-control" id="yourEmail">
             </div>
         </p>
     </div>
     </div>
     ...
     <div class="card-body">
         ...
         <p class="card-text">
             <div class="col-12 mb-3">
                 ...
                 <input type="number" value="{{ $pack['stock']  }}" name="stock" class="form-control" id="yourName">
             </div>
             ...
             {{-- <div class="col-12 mb-3">
                 <label for="yourUsername" class="form-label">Couleur du pack</label>
  ...
  <script type="text/javascript">
    ...
    allowClear: true
      ...
      $('select[name="category"]').on('change', function (){
              ...
              if (catId) {
                  $.ajax({
                      url: '/admin/pack/loadSubCat/' + catId,
                      type: "GET",
                      dataType: "json",
...
for (let index = 0; index < getImage.length; index++) {
  ...
  $("<span class=\"pip\">" +
            ...
            $(".remove").click(function(e){
             ...
             if (getId) {
              $.ajax({
                      url: '/admin/pack/deleteImage/' + getId,
                      type: "GET",
                      dataType: "json",
