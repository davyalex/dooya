...
<div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="pt-1 pb-5 justify-content-around">
        <a href="{{ route('pack') }}" class="btn btn-primary"><i class="bi bi-list-ul"></i> Liste des packs</a>
          
        <h5 class="card-title text-center pb-0 fs-4">Ajouter un pack</h5>
      </div>

      <form action="{{ route('pack.store') }}" method="POST" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
